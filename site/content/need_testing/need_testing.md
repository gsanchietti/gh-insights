...
## NethVoice
- :point_right: **[Mobile app migration from /webrest to /api](https://github.com/NethServer/dev/issues/7875)** (#7488) by *tommaso-ascani* (Created: 2026-02-13, Updated: 2026-02-23T14:25:54Z)
- :point_right: **[NethVoice: add OVAL VoIP provider into wizard menu](https://github.com/NethServer/dev/issues/7853)** (#7488) by *fabbri-marco* (Created: 2026-02-09, Updated: 2026-02-23T16:06:51Z)
- :point_right: **[NethVoice Proxy: Use local IP in SDP for local clients to simplify NAT configuration](https://github.com/NethServer/dev/issues/7725)** (#7488) by *Amygos* (Created: 2025-11-03, Updated: 2026-02-17T15:59:50Z)
